    ...
    >
      <td className="px-6 py-6">
        <div className="flex items-center gap-5">
          <div className="w-12 h-12 rounded-xl bg-[#121214] flex items-center justify-center border border-white/10 shadow-[inner_0_0_10px_rgba(0,0,0,0.5)]">
      ...
      <td className="px-6 py-6 text-center">
        <span className={`px-4 py-1.5 text-[9px] font-black uppercase rounded-xl tracking-[0.2em] italic ${getStatusClass(campaign.status)}`}>
          {campaign.status}
        </span>
      </td>
      ...
      <td className="px-6 py-6 text-right">
        <button className="p-2 text-white/20 hover:text-[#FF0032] transition-colors rounded-xl border border-white/5 hover:border-[#FF0032]/30">
        ...
        <Revealstagger delay={0.1}>
          <Reveal y={40} delay={0.2}>
            ...
            <div className="grid grid-cols-12 gap-8 mb-16">
              <div className="col-span-12 lg:col-span-8 bg-[#121214] rounded-xl p-12 border border-white/5 relative overflow-hidden group">
              ...
              <div className="col-span-12 lg:col-span-4 grid grid-rows-2 gap-8">
                <div className="bg-[#121214] rounded-xl p-8 border border-white/5 flex flex-col justify-between relative group overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-end justify-between gap-6 border-b border-white/5 pb-8 mb-4">
              ...
              <div className="flex gap-4">
                <div className="relative group">
                    <select 
                      className="bg-[#121214] text-white/60 text-[10px] font-black uppercase tracking-[0.3em] pl-6 pr-12 py-4 border border-white/10 outline-none focus:border-[#FF0032] transition-all rounded-xl appearance-none italic shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]"
                      value={statusFilter}
                ...
                <button onClick={exportCsv} className="px-6 py-4 bg-white/5 text-white/50 text-[10px] font-black uppercase tracking-[0.3em] border border-white/10 hover:text-white hover:bg-white/10 transition-all rounded-xl italic flex items-center gap-3">
          ...
          <Reveal delay={0.4}>
            ...
            <div className="bg-[#0A0A0C] rounded-xl border border-white/5 shadow-2xl overflow-hidden mb-12 relative">
