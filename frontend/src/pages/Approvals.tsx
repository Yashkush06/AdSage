          ...
          <div className="bg-surface-container-low p-1.5 rounded-2xl flex gap-1 shadow-sm border border-outline-variant/10">
            <button
              ...
              className={`px-6 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all ${
                tab === "pending" ? "bg-white text-primary shadow-sm" : "text-stone-400 hover:text-stone-600"
              }`}
            >
            ...
            <button
              ...
              className={`px-6 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all ${
                tab === "history" ? "bg-white text-primary shadow-sm" : "text-stone-400 hover:text-stone-600"
              }`}
            >
              History
            </button>
        ...
        {tab === "pending" && (
          pending.length === 0 ? (
            <div className="bg-surface-container-low rounded-3xl p-20 text-center border-2 border-dashed border-outline-variant/20">
              ...
              <button className="mt-8 px-6 py-2 bg-white text-primary text-[10px] font-bold uppercase tracking-widest rounded-full border border-outline-variant/30 hover:shadow-md transition-shadow">
                Refresh Protocol
              </button>
            </div>
          ) : (
